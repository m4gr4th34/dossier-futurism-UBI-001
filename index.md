...
The model that turns this into arithmetic — its parameter ranges are engineering judgments, not empirical findings (claim `C14`: τ in a 0.5–3% viable band, real yield 1.5%, retention ρ 20%) — returns a blunt result, stated strictly as model output under those stated assumptions. At τ=2%, every $50,000 of wrapped assets per member yields **$1,000/yr** in full levy, of which about **$800** is paid out in the first year before the treasury compounds. So Rings 1–2 fund a *poverty-relevant* dividend at bounded membership (the hundred-thousand-member stretch case) or a merely *symbolic* one at population scale. A universal *floor* ($2,000/yr) is out of reach without Ring 3, the minimal leviathan: even wrapping the global mean (~$95,384 per member, UBS 2024) yields only **~$1,908/yr** — just under the floor tier — so redistributing even mean wealth stops fractionally short. And a *living wage* from levies alone is arithmetically unreachable at any survivable τ: even 5% on mean global wealth is only ~$4,800/yr. The conclusion the arithmetic forces is narrow and honest — redistribution sets a floor; it does not manufacture a wage. For more than a floor, **the commons itself must grow**.
...
Austria's central bank suppressed the Wörgl scrip in 1933; the legal kill-switch on parallel currencies is old, and a protocol levy on securities can simply be prohibited. Jurisdictional analysis is unfinished work.
...
**Vicente (2023), Web3-enabled Harbergeorgism.** The closest work: a Harberger-plus-Georgist levy on tokenized *land* whose surplus *may* fund a citizens' dividend for a charter city. Four distinctions. It levies land, not covenant-wrapped real-world assets broadly. Its dividend is conditional on tax surplus rather than a standing floor, and its staking city-coin carries issuance-like rewards — whereas the Commonwealth's treasury invariant forbids minting and pays a zero-issuance floor. Its beneficiary is a charter-city government; ours is a non-state pay-community. And it runs *two* tokens (a stakeable city-coin plus soulbound property tokens), where the Commonwealth's single-token payability is load-bearing, not cosmetic: because the levy is payable only in the dividend token, the asset-holders who owe the levy must acquire it from the dividend-recipients who hold it — that one fact makes the recipients the levy-payers' structural counterparties, the demand every two-token design in the graveyard failed to manufacture.
...
| Work incentives (the pilots) | Finland, Kenya, Stockton, and Alaska show small-to-null labor-supply effects at modest transfers; no pilot reaches the living-wage regime. Citation audit closed 2026-07-29 (C05 ESTABLISHED); the living-wage extrapolation stays open (C06). | ESTABLISHED | — | C05, C06 |
...
**Proof of Humanity's UBI token — died of no-sink issuance plus governance capture.** One token per verified human per hour, streamed continuously, with only cosmetic burns: relentless sell pressure met no structural demand, and the Kleros cooperative's post-mortem — an interested party, so REPORTED, not independently verified — documents an ~87% loss on its own liquidity position and a governance war in which token-aligned voters passed proposals that effectively forked the registry. The identity layer and the money layer captured each other. *Forecloses: naked streaming issuance; shared governance between registry and token.*
...
**Banerjee, A., Faye, M., Krueger, A., Niehaus, P., Suri, T. (2023).** Universal Basic Income: Short-Term Results from a Long-Term Experiment in Kenya. Working paper, 15 Sept 2023 (author/GiveDirectly-hosted; the audit found no NBER number for this paper — the group's NBER w25598 is a different 2019 paper — so none is cited). ~23,000 treated adults across three arms: a 12-year monthly UBI, a 2-year monthly UBI, and a one-time lump sum (~$500) — at $0.75/day (~$22.50/month, ~$270/yr) per adult. Finding: labor supply unchanged overall, shifting from wage work toward self-employment and enterprise.
...
**EIP-5320 (2022), "Harberger Taxes NFT" (author: greenlucid).** A draft pull request (#5320) to the ethereum/EIPs repository proposing an interface for NFTs under continuous self-assessed (Harberger/COST) taxation; it was closed unmerged on 2022-12-25 and never became a canonical EIP. Cited as a proposal, not an adopted standard.
...
**Duniter/Ğ1 — independently corroborated:** Siddarth, D., Ivliev, S., Siri, S., Berman, P. (2020). Who Watches the Watchmen? A Review of Subjective Approaches for Sybil-resistance in Proof of Personhood Protocols. Frontiers in Blockchain 3:590171 (arXiv:2008.05300) — confirms Ğ1 as a Relative-Theory-of-Money implementation paying a daily Universal Dividend recalculated every six months as a proportion of the monetary mass, small-scale (2,801 holders, Sept 2020) and mostly francophone; and Gensollen, M. & Latapy, M. (2020), A case study in the Ğ1 cryptocurrency, Applied Network Science 5:25 (arXiv:1911.10792). The 2017 launch is corroborated by structured-data sources. The exact ~10%/yr UD calibration and the "longest-running" comparison come from project sources (Laborde, S. (2010), Relative Theory of Money) — REPORTED.

**Mattsson, C.E.S., Criscione, T., Takes, F.W. (2023).** Circulation of a digital community currency. Scientific Reports 13:6541. DOI 10.1038/s41598-023-33184-1 (arXiv:2207.08941). An independent flow-network analysis of ~40,000 users of Sarafu (Kenya) finding highly modular, geographically localized circulation — the community currency operates in local demand loops. The demurrage mechanism (2%/month from Feb 2021) is documented in the paired data descriptor, Mattsson, Criscione & Ruddick (2022), Scientific Data 9:426, DOI 10.1038/s41597-022-01539-4.

**Knapp, G.F. (1905/1924).** The State Theory of Money. German original Staatliche Theorie des Geldes (1905); abridged English edition trans. H.M. Lucas & J. Bonar for the Royal Economic Society, Macmillan, 1924. Origin of chartalism: money is a creature of law and holds value because obligations — above all the state's — are payable in it. The extension that a non-state pay-community can, on the same logic, issue chartal money is Rallo's (2020) reading of Knapp, not Knapp's own emphasis (Knapp centers the state) — see the Rallo card. That reading is the premise Part II's demand loop rests on.

**Weyl, E.G. & Zhang, A.L. (2022).** Depreciating Licenses. American Economic Journal: Economic Policy 14(3), 422–448. DOI 10.1257/pol.20200426 (working paper SSRN 3698941). Partial/common-ownership licenses under a self-assessed depreciating levy; a tunable rate trades allocative against investment efficiency; the mechanism does not induce universally truthful valuations (the standard Harberger limit) — the Layer-2 mechanism and its named caveat.

**Owusu Ansah, B., Voss, W., Asiama, K.O., Wuni, I.Y. (2023).** A systematic review of the institutional success factors for blockchain-based land administration. Land Use Policy 125, art. 106473. DOI 10.1016/j.landusepol.2022.106473 (identity verified; full text not accessed). A review of 37 studies; Georgia is confirmed by the review as the leading successful adoption. The Honduras (stalled on political resistance) and Sweden (multi-phase pilots that never went to production) cases are per the broader public record rather than verified line-by-line against the review — the evidence behind Ring 3's jurisdiction requirement.

**Vicente, Bernardo M. (2023).** Web3-enabled Harbergeorgism: A Policy Mechanism for Charter Cities. Charter Cities Institute Research Paper (Jan 2023), chartercitiesinstitute.org. The strongest near-miss for C10: a Harberger-plus-Georgist levy on tokenized land whose surplus may fund a conditional citizens' dividend — distinct from the Commonwealth on four counts (land not covenant-wrapped RWAs; a conditional surplus-funded dividend, with issuance-like rewards on its staking city-coin, not a zero-issuance floor; a charter-city government beneficiary not a non-state pay-community; two tokens not the single-token payability that makes recipients the levy-payers' counterparties), with no personhood firewall, no chartalist anchor, and no stability frontier.
...
**Bruenig, Matt (2018).** Social Wealth Fund for America. People's Policy Project. A collectively-owned "American Solidarity Fund" paying a per-person "universal basic dividend" from investment returns, with one non-transferable share per citizen; the state acquires the assets by purchase, taxation, and share transfers — statist, off-chain, and levy-free. The nearest yield-dividend right, distinguished by the Commonwealth's covenant levy and firewalled registry.

**Olson, Mancur (1965; rev. 1971).** The Logic of Collective Action: Public Goods and the Theory of Groups. Harvard University Press. Small privileged groups organize and over-provide; large latent groups free-ride — the concentrated-costs / diffuse-benefits account of why organized interests defeat unorganized ones, the ideology-free basis for Part III's non-adoption argument (C17).
